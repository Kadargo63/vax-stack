...
class Appointments extends Component {
    ...
    handleSubmit(e) {
        ...
        if (this.chckBtn.context._errors.length === 0 && !this.state.dateError) {
                            ...
                            >
                                ...
                                <div className="mb-5">
                                    ...
                                    <DatePicker
                                        ...
                                        className="block w-full p-3 rounded bg-gray-200 border border-transparent focus:outline-noe focus:bg-gray-100"
                                    />
